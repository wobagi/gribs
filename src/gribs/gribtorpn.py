...
def cli():
    ...
    parser.add_argument("--glob", "-g", type=str, default="*.grib?", help="Glob string applied to all specified source dirs. Does not affect individual files specified explicitly. Defaults to '*.grib?' to match both grib and grib2 extension.")
    parser.add_argument("--etiket", "-e", type=str, default="G092V3N", help="Set etiket column value for resulting rpn file.")
